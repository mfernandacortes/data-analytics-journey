-- Empleados con ventas totales por encima del promedio general
-- Dataset: Northwind | Tablas: Employees, Orders, Order Details
-- Técnica: CTEs encadenadas + subquery en WHERE
